...
public class AllyAddScriptEvent extends BukkitScriptEvent implements Listener {
    private AllyClanAddEvent event;

    public AllyAddScriptEvent() {
    }
    ...
    public boolean couldMatch(ScriptPath path) {
        return path.eventLower.startsWith("clan ally add");
    }
}
